...
- receber a fase da Wanda via entrada do usuario
- criar mais casos para outras fases ou personagens
- separar a logica em metodos para facilitar testes
- adicionar testes automatizados para validar as saidas

## Observacao

Os arquivos `.java` atuais aparentam ter problema de codificacao em alguns textos acentuados. Isso nao impede o entendimento do exemplo, mas vale ajustar a codificacao para UTF-8 se voce quiser preservar os acentos corretamente no codigo-fonte e na saida.
